		...
		<form class="form-horizontal" method="post" target="_self">
			...
			<div class="form-group">
				<label class="col-sm-5">
					...
					<span tabindex="0" class="glyphicon glyphicon-exclamation-sign" role="button" data-toggle="popover" data-trigger="focus"
					 data-placement="top" data-content="This application's front-end UI is base on bootstrap, we have built-in multiple themes (source from https://bootswatch.com). Just change this setting to get different UI style."></span>
				</label>
				<div class="col-sm-7">
			...
			<div class="form-group">
				<label class="col-sm-5">
					...
					<span tabindex="0" class="glyphicon glyphicon-exclamation-sign" role="button" data-toggle="popover" data-trigger="focus"
					 data-placement="top" data-content="Here you can write down your hello message with your guest, tell them why you create this website and your Page core concept."></span>
				</label>
				<div class="col-sm-7">
			...
			<div class="form-group">
				<label class="col-sm-5">
					...
					<span tabindex="0" class="glyphicon glyphicon-exclamation-sign" role="button" data-toggle="popover" data-trigger="focus"
					 data-placement="top" data-content="Here you can establish some rules to require guest to accept."></span>
				</label>
				<div class="col-sm-7">
			...
			<div class="form-group">
				<label class="col-sm-5">
					@lang('dashboard.fb_page_token')
				</label>
				<div class="col-sm-7">
					<input type="text" name="fb_page_token" class="form-control input-sm" value="{{ $setting['fb_page_token'] or '' }}" />
				</div>
			</div>
			...
			<div class="form-group">
				<label class="col-xs-5">
					...
					<span tabindex="0" class="glyphicon glyphicon-exclamation-sign" role="button" data-toggle="popover" data-trigger="focus"
					 data-placement="top" data-content="Only effective with chinese content. Advanced mode will automatically find content containing homonyms."></span>
				</label>
				<div class="col-xs-7">
					<div class="material-switch pull-right">
						<input id="advanceBlockModeToggle" name="advance_block_mode" type="checkbox" @if ($setting[ 'advance_block_mode']=='on' )
			...
			<div class="form-group">
				<label class="col-xs-5">
					...
					<span tabindex="0" class="glyphicon glyphicon-exclamation-sign" role="button" data-toggle="popover" data-trigger="focus"
					 data-placement="top" data-content="We don't suggest to log guest's ip --which is inconsistent with the concept of anonymous-- only if you CONNOT easily deal with spam & abuse. It still dose not be recommended as a best response due to people can change the IP with VPN or proxy service."></span>
				</label>
				<div class="col-xs-7">
					<div class="material-switch pull-right">
						<input id="logGuestIpToggle" name="log_guest_ip" type="checkbox" @if ($setting[ 'log_guest_ip']=='on' ) checked="checked"
						 @endif />
			...
			<div class="form-group">
				...
				<div class="col-xs-7">
					<div class="material-switch pull-right">
						<input id="encryptGuestIpToggle" name="encrypt_guest_ip" type="checkbox" @if ($setting[ 'encrypt_guest_ip']=='on' ) checked="checked"
						 @endif />
			...
			<div class="form-group">
				<label class="col-xs-5">
					...
					<span tabindex="0" class="glyphicon glyphicon-exclamation-sign" role="button" data-toggle="popover" data-trigger="focus"
					 data-placement="top" data-content="When in maintenance mode, guest will not allow to visit the form page until you turn it off. Be sure to change the setting when you are going to maintain or change settings for your website."></span>
				</label>
				<div class="col-xs-7">
					<div class="material-switch pull-right">
